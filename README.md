...
5. Working with this project from anything other than \*nix systems is untested. In theory, you should be able to do all of the above from a Windows machine, but it's untested.
